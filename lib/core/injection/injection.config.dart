...
import '../shared/session_manager/i_session_manager.dart' as _i6;
import '../shared/session_manager/session_manager.dart' as _i7;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.singleton<_i5.FirebaseAuth>(() => localModule.firebaseAuth());
    gh.factory<_i6.ISessionManager>(
        () => _i7.SessionManager(gh<_i3.FlutterSecureStorage>()));
    gh.factory<_i8.IProductRepository>(
        () => _i9.ProductRepositoryImpl(gh<_i4.FirebaseFirestore>()));
    gh.factory<_i10.IBrandRepository>(
        () => _i11.BrandRepositoryImpl(gh<_i4.FirebaseFirestore>()));
    gh.factory<_i12.AuthGuard>(() => _i12.AuthGuard(gh<_i6.ISessionManager>()));
    gh.factory<_i13.GetBrandList>(
        () => _i13.GetBrandList(gh<_i10.IBrandRepository>()));
    gh.factory<_i14.IReviewRepository>(
        () => _i15.ReviewRepositoryImpl(gh<_i4.FirebaseFirestore>()));
    gh.factory<_i16.IOrderRepository>(() => _i17.OrderRepositoryImpl(
          gh<_i4.FirebaseFirestore>(),
          gh<_i5.FirebaseAuth>(),
        ));
    gh.factory<_i18.ICartRepository>(
        () => _i19.CartRepositoryImpl(gh<_i4.FirebaseFirestore>()));
