...
import '../../features/brand/domain/usecases/get_brand_list.dart' as _i14;
...
import '../../features/cart/domain/usecases/add_to_cart.dart' as _i23;
import '../../features/cart/domain/usecases/delete_cart_item.dart' as _i25;
import '../../features/cart/domain/usecases/get_cart_items.dart' as _i26;
import '../../features/cart/domain/usecases/update_cart_item.dart' as _i24;
...
import '../../features/order/data/repository/order_repository_impl.dart'
    as _i18;
import '../../features/order/domain/repository/order_repository.dart' as _i17;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i14.GetBrandList>(
        () => _i14.GetBrandList(gh<_i10.IBrandRepository>()));
    gh.factory<_i15.IReviewRepository>(
        () => _i16.ReviewRepositoryImpl(gh<_i3.FirebaseFirestore>()));
    gh.factory<_i17.IOrderRepository>(() => _i18.OrderRepositoryImpl(
          gh<_i3.FirebaseFirestore>(),
          gh<_i4.FirebaseAuth>(),
        ));
    gh.factory<_i19.ICartRepository>(
        () => _i20.CartRepositoryImpl(gh<_i3.FirebaseFirestore>()));
    gh.factory<_i21.BrandBloc>(() => _i21.BrandBloc(
          gh<_i14.GetBrandList>(),
          gh<_i13.GetSpecificBrand>(),
        ));
    gh.factory<_i22.DataPopulation>(() => _i22.DataPopulation(
          gh<_i10.IBrandRepository>(),
          gh<_i3.FirebaseFirestore>(),
          gh<_i8.IProductRepository>(),
        ));
    gh.factory<_i23.AddToCart>(
        () => _i23.AddToCart(gh<_i19.ICartRepository>()));
    gh.factory<_i24.UpdateCartItem>(
        () => _i24.UpdateCartItem(gh<_i19.ICartRepository>()));
    gh.factory<_i25.DeleteCartItem>(
        () => _i25.DeleteCartItem(gh<_i19.ICartRepository>()));
    gh.factory<_i26.GetCartItems>(
        () => _i26.GetCartItems(gh<_i19.ICartRepository>()));
    gh.factory<_i27.GetProductList>(
        () => _i27.GetProductList(gh<_i8.IProductRepository>()));
    gh.factory<_i28.CartBloc>(() => _i28.CartBloc(
          gh<_i23.AddToCart>(),
          gh<_i26.GetCartItems>(),
          gh<_i25.DeleteCartItem>(),
          gh<_i24.UpdateCartItem>(),
          gh<_i4.FirebaseAuth>(),
        ));
    gh.factory<_i29.AddOrder>(() => _i29.AddOrder(gh<_i17.IOrderRepository>()));
    gh.factory<_i30.GetProductReviews>(
        () => _i30.GetProductReviews(gh<_i15.IReviewRepository>()));
